		...
		<fieldset class="w3-container" style="margin-left: 260px">
			<div id="allList" class="">
				<table class="table table-hover">
					...
					<c:forEach var='employee' items='${employeeListGetByPosition}'
						varStatus="status">
						<tr class="">
						...
						<div class="modal fade" id="exampleModalCenter${employee.empId}"
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<form class='center' name="editForm${employee.empId}"action="${pageContext.request.contextPath}/empManage/EmployeeListByEmployeePositionEdit.action/${employee.empId}?currentPageNoBtnEmployeePosition=${currentPageNo}&whichPosition=${whichPosition}" method="post" enctype="multipart/form-data">
					...
					<ul class="pagination">
						<c:if test="${currentPageNo <= 1}">
							<li class="page-item disabled"><a class="page-link"
								href="<c:url value='EmployeeListByPosition.action?currentPageNoBtnPosition=1&whichPosition=${whichPosition}' />"
						...
						<c:if test="${currentPageNo <= 1}">
							<li class="page-item disabled"><a class="page-link"
								href="<c:url value='EmployeeListByPosition.action?currentPageNoBtnPosition=${currentPageNo-1}&whichPosition=${whichPosition}' />"
						...
						<c:if test="${currentPageNo != totalPages}">
							<li class="page-item"><a class="page-link"
								href="<c:url value='EmployeeListByPosition.action?currentPageNoBtnPosition=${currentPageNo+1}&whichPosition=${whichPosition}' />">Next</a>
							</li>
						</c:if>
						<c:if test="${currentPageNo == totalPages}">
							<li class="page-item disabled"><a class="page-link"
						...
						<c:if test="${currentPageNo == totalPages}">
							<li class="page-item disabled"><a class="page-link"
								href="<c:url value='EmployeeListByPosition.action?currentPageNoBtnPosition=${totalPages}&whichPosition=${whichPosition}' />"
