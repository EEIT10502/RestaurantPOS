						...
						<div class="modal fade" id="exampleModalCenter${product.pId}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<form class='center' name="editForm${product.pId}" action="${pageContext.request.contextPath}/productManage/ProductListByCateEdit.action/${product.pId}?currentPageNoBtnCate=${currentPageNo}&whichCate=${whichCate}" method="post">
