...
<<<<<<< HEAD
            <a href="<c:url value="/empManage/empInsert"/>" class="w3-bar-item w3-button">新增員工資訊</a>
			<a href="<c:url value="/empManage/allEmployeeList.action"/>" class="w3-bar-item w3-button">查詢員工資訊</a>
