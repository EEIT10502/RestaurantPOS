	...
	<div id="all">
		...
		<div id="calContent">
			<tbody>
				...
				<tr>
					<td rowspan="2"><input type="button" value="上班"  style="height: 140px" id="checkIn" class="btn btn-warning"></td>
				...
				<tr>
					<td rowspan="2"><input type="button" value="下班"  style="height: 140px" id="checkOut" class="btn btn-warning"></td>
